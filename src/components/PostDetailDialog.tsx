...
import { CSSTransition, TransitionGroup } from 'react-transition-group'; // Re-import TransitionGroup and CSSTransition
      ...
      <DialogContent className="sm:max-w-[950px] max-h-[98vh] flex flex-col">
        <> {/* Start of React.Fragment */}
          ...
          <div className="relative flex-grow overflow-hidden flex">
            <TransitionGroup className="relative w-full h-full"> {/* Re-added TransitionGroup */}
              <CSSTransition
