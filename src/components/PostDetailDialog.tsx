      ...
      <DialogContent className="sm:max-w-[950px] max-h-[98vh] flex flex-col">
        ...
        {canGoPrevious && (
          <Button
            variant="outline"
            size="icon"
            className="absolute left-16 top-1/2 -translate-y-1/2 rounded-full z-20 h-12 w-12 bg-background text-foreground border-2 border-border hover:border-blue-500 hover:bg-accent hover:text-accent-foreground transition-colors"
            onClick={onPrevious}
          >
        ...
        {canGoNext && (
          <Button
            variant="outline"
            size="icon"
            className="absolute right-16 top-1/2 -translate-y-1/2 rounded-full z-20 h-12 w-12 bg-background text-foreground border-2 border-border hover:border-blue-500 hover:bg-accent hover:text-accent-foreground transition-colors"
            onClick={onNext}
          >
