...
const PostDetailDialog: React.FC<PostDetailDialogProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[950px] max-h-[98vh] flex flex-col relative"> {/* Added relative here */}
        <> {/* Start of React.Fragment */}
          ...
          {/* Main content area */}
          <div className="flex-grow overflow-hidden relative"> {/* Removed 'flex' from here, as it's not needed for this div itself */}
          ...
          {/* Navigation buttons - now direct children of DialogContent */}
          {canGoPrevious && (
            <Button
              variant="outline"
              size="icon"
